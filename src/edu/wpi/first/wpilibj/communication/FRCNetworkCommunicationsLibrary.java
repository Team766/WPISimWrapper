...
public class FRCNetworkCommunicationsLibrary extends JNIWrapper {
  ...
  public static int HALSendError(boolean isError, int errorCode, boolean isLVCode, String details, String location, String callStack, boolean printMsg){
	  return 1;
  }
}
